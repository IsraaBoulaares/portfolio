...
import javafx from '../app/assets/svg/skills/javafx.svg';
...
import openaiapi from '../app/assets/svg/skills/openaiapi.svg';
...
import uxui from '../app/assets/svg/skills/UXUI.svg';
...
export const skillsImage = (skill) => {
  ...
  switch (skillID) {
    ...
    case 'react.js':
      return react;
    case 'node.js':
      return nodejs; // Fix: added nodejs import and mapping
    case 'svelte':
      return svelte;
    case 'typescript':
      return typescript;
